...
function initial() {
	...
	$_PAGE = array ();
	$_PAGE ['title'] = 'Generar libro Ventas a Contribuyente';
	$_PAGE ['links'] = null;
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Generar libro Ventas a Contribuyente</h5>
                        </div>
...
echo "<script src='js/funciones/funciones_venta_contribuyente.js'></script>";
		} //permiso del script
else {
