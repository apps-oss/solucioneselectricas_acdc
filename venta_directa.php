  ...
  <div class="wrapper wrapper-content  animated fadeInRight">
    <div class="row">
                          ...
                          <table>
                            <tbody>
                              ...
                              <tr>
                                  ...
                                  <td class='cell100 column50  text-right text-green'><input type="text"  id='total_monto_final' class="txt_box2"   value="" readOnly> </td>
                              </tr>
      ...
      <?php
              ...
              echo "<script src='js/funciones/venta_directa.js?v=$uniqueId'></script>";
