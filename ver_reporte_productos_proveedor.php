...
function initial()
{
    ...
    $_PAGE = array();
    $_PAGE ['title'] = 'Reporte ventas por prodcuto del proveedor';
    $_PAGE ['links'] = null;
    ...
    <div class="col-lg-12">
      <div class="ibox ">
        <div class="ibox-title">
          <h5>Reporte productos por proveedor</h5>
        </div>
...
include_once("footer.php");
        echo "<script src='js/funciones/reporte_producto_proveedor.js'></script>";
    } //permiso del script
    else {
