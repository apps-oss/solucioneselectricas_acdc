...
function initial() {
  ...
  $_PAGE ['title'] = $title;
	...
	$total_forma_pago= $total_contado_2+$total_tarjeta_2+$total_cheque_2+ $total_credito_2+$total_vale_2;
						...
						<div class="ibox-content">
							<form name="formulario" id="formulario">
								<div class="row">
									...
									<input type='text' class='form-control' id='fecha' name='fecha' value='$fecha_actual' readonly></div>";
									echo "</div>";
									$url_lect="lectura_dia.php?id_apertura=$aper_id&fecha=$fecha_actual";
									?>
									<div class="col-md-6 pull-right"><br>
										<!--Caja pista = 2 , muestra la lectura de las Bombas  -->
										<?php if 	($tipo_caja ==2){ ?>
										<a class="btn btn-md btn-success pull-right" style="margin-left:1%;"
								...
								<div  class="row" id='totalXpago' hidden>
									<div class="col-md-4">
										<div class="form-group has-info single-line">
									...
									<div class="col-md-4">
										<div class="form-group has-info single-line">
											<label>Total Ventas con Tarjeta $ </label> <input type='text'  class='form-control' id='total_tarjeta' name='total_tarjeta' value='<?php echo $total_tarjeta_2;?>' readOnly>
										</div>
									</div>
								</div>
								...
								<table class="table table-border" id="table_t">
									<thead>
										<tr>
											<th class="col-md-4">Total Arqueo Caja $</th>
											<th class="col-md-4" style="text-align: center">Total Sistema $</th>
									...
									<tbody id="table_data">
										<tr>
											<td>
												<input type="text" id="total_efectivo" name="total_efectivo" value="0"  class="decimal input_clear">
											</td>
										...
										<?php if 	($tipo_caja ==2){ ?>
										<div class="row">
												<div class="col-lg-3">Total $ Lectura de Bombas	</div>
												<div class="col-lg-3">
													<input type="text" id="total_dinero_lectura" name="total_dinero_lectura" value="0"  class="decimal input_clear">
										</div>
										<div class="col-lg-3">Total Galones Lectura de Bombas	</div>
										<div class="col-lg-3">
											<input type="text" id="total_galones" name="total_galones" value="0"  class="decimal input_clear"></div>
								</div>
								  <?php } ?>
									<div class="row">
										<div class="col-lg-12">
	...
	function corte()
	{
		...
		function cambio()
		{
		 ...
		 $total_fin_dinero_lect  = $total_dinero_lectura + $total_impuestos ;
		  $total_fin_dinero_lect  = sprintf("%.2f", $total_fin_dinero_lect);
		 $rc = getDatosCaja($caja);
	 	 $tipo_caja = $rc["tipo_caja"];
...
function arqueo(){
	...
	$insertar = false;
 //	json_arr: [{"id":"1","qty":100,"subt":"100"},{"id":"2","qty":100,"subt":"100"},{"id":"3","qty":20,"subt":"20"},{"id":"4","qty":10,"subt":"10"},{"id":"5","qty":5,"subt":"5"},{"id":"6","qty":0,"subt":"0"},{"id":"7","qty":0.25,"subt":"0.25"},{"id":"8","qty":0,"subt":"0"},{"id":"9","qty":0,"subt":"0"},{"id":"10","qty":0,"subt":"0"},{"id":"11","qty":0,"subt":"0"}]
 if ($cuantos>0) {
