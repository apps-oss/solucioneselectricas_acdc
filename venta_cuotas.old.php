          ...
          if ($links!='NOT' || $admin=='1') {
              ...
              <div class="ibox-content">
                ...
                <div class="row focuss"><br>
                  ...
                  ?>
                  <button type="button" id="btnCotiza" name="btnCotiza" class="btn btn-sm btn-primary pull-right usage"><i class="fa fa-money"></i> F4 Cotizacion</button>'
                  </div>
                </div>
                <div class="row">
        ...
        if ($cuantos>0) {
          ...
          AND  subtotal ='$subtotal'";
                ...
                if ($alias_pago=='CRE') {
                    $table_cr="credito";
                    /*
            replicar cambios de esta funcion para o de credito a venta.php
            revisar el js para que si el monto digitado mayor que valor facturado
            monto digitado lo haga igual a  valor facturado
            }*/
              ...
              <div class="row text-center">
                ...
                <div class="row">
                  ...
                  <tbody id='creditt' hidden >
                    <tr class='creditoss'>
                      <td><h5 class='text-danger'>Monto $ </h5></td>
                      <td><input type="text" id="valorcredito" name="valorcredito" value=""  class=" decimal form-control montoMetodoPago"> </td>
                    </tr>
                    <tr  class='creditoss'>
                      <td><h5 class='text-success'>Dias </h5> </td>
                      <td> <input type="text" id="diascredit" name="diascredit" value=""  class=" decimal form-control"  ></td>
...
<!-- COBRAR PRIMA-->
                  ...
                  <div class='col-md-12 left-margin'>
							...
							<div class=' form-group has-feedback'>
								<input type='hidden' id='correlativo' name='correlativo' value='938'>
							  </div>
							<div class='clearfix'></div></br>

              <div class='col-md-6 col-sm-6 col-xs-6 form-group has-feedback'>
               <label class="control-label">Monto Cotizar Plazos: </label>
               <input type='text' id='valorcredito' name='valorcredito' class='form-control has-feedback-right' placeholder='0.00' >
              </div>
							  <div class='col-md-6 col-sm-6 col-xs-6 form-group has-feedback'>
								<label class="control-label">Fecha: </label>
									<input name='fecha' type='date' value='2022-10-19' class='date-picker form-control col-md-8 col-xs-8' required='required'>
							  </div>
                <?php
             ...
             <div class='col-md-6 col-sm-6 col-xs-6 form-group has-feedback'>
                 ...
                 <input type='text' id='porc_minimo' name='porc_minimo' class='form-control decimal'   value='' placeholder='Efectivo' >
						...
						<div class='col-md-6 col-sm-6 col-xs-6 form-group has-feedback'>
							...
							<label class="control-label">Cuota: </label>
							  ...
							  <div class='col-md-6 col-sm-6 col-xs-6 form-group has-feedback'>
								...
								<select list="b_proveedor" id="id_vendedor" name="id_vendedor" class="select3_single form-control" >
							  ...
							  <div class='col-md-6 col-sm-6 col-xs-6 form-group has-feedback'>
								<label class="control-label">Comprobante: </label>
								  <select class='form-control has-feedback-right' id='tipo' name='tipo' >
										<option value='3' selected>Nota</option>
						...
						<div class='col-md-6 col-sm-6 col-xs-6 form-group has-feedback'>
							<label class="control-label">% de Comisión: </label>
								<input type='number' id='comision' name='comision' class='form-control has-feedback-right' step="0" min="0" max="50" value='' placeholder='Comisión' required onfocus='this.select();'>
              ...
              <center>
								...
								<button type='submit' id='addf' name='addf' class='btn btn-round btn-success addf'><i class='fa fa-print'></i> Finalizar</button>
							</center>
