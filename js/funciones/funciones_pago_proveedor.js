...
function senddata() {
  ...
  var urlprocess = 'pago_proveedor.php';
  facturas = $('[name="duallistbox_demo2"]').val();
  id_proveedor = $('#select_proveedor').val();
  id_cuenta = $('#cuenta').val();
  forma = $('#forma').val();
  ...
  dataString = "process=" + process + "&array_json=" + json_arr + "&array_json2=" + json_arr2 + "&id_cuenta=" + id_cuenta + "&total_a_p=" + total_a_p + "&id_proveedor=" + id_proveedor+ "&forma=" + forma;
  $.ajax({
    type: 'POST',
    url: urlprocess,
    data: dataString,
