...
<div class="gray-bg">
  <div class="wrapper wrapper-content  animated fadeInRight">
    <div class="row">
                ...
                <div class="row focuss"><br>
                  <!--div class="form-group col-md-4">
                    ...
                    <div id="b" class='col-md-4'>
                      <label id='buscar_habilitado'>Buscar Producto (Descripción ó Código)</label>
                  ...
                  ?>
                  <button type="button" id="btnCotiza" name="btnCotiza" style="margin-left:1%;margin-right:1%;"
                  class="btn btn-sm btn-info pull-right usage"><i class="fa fa-money"></i> F4 Cotizacion</button>
                  </div>
                </div>
                <div class="row">
                          ...
                          <table>
                            <tbody>
                              <tbody id="totals">
                                ...
                                <td class="cell100 column25  leftt text-bluegrey "><?php echo $id_imp?> TOTAL CONTADO $:</td>
                                <td hidden class="cell100 column1  text-right text-green"  id='total_final'>0.00</td>
                                <td class='cell100 column25 text-right text-green' id='total_gravado'>0.00</td>
                                </tr>
                                <tr>
                                  <td class='cell100 column100 text-bluegrey'  id='totaltexto'>&nbsp;</td>
                                </tr>
                      ...
                      <div class="table100 ver1 m-b-10">
                        <div class="table100-head">
                          <table id="inventable1">
                            <thead>
                              <tr class="row100 head">
                                <th class="success cell100 column100 text-center">INFORMACION CREDITO CUOTAS</th>
                              </tr>
                            </thead>
                          </table>
                        </div>
                        <div class="table101-body">
                          <table>
                            <tbody>
                              <tr>
                                <td class='cell100 column70 text-success'>FECHA VENCE MES : </td>
                                <td class='cell100 column30'><input type="text" id="fecha_credito2" class="txt_box2"  value="" readonly></td>
                              </tr>
                              <tr>
                                <td class='cell100 column70 text-success'>TOTAL CREDITO: $</td>
                                <td class='cell100 column30'><input type="text" id="total_credito2" class="txt_box2"  value="" readOnly></td>
                              </tr>
                              <tr>
                                <td class='cell100 column70 text-success'>PRIMA: $</td>
                                <td class='cell100 column30'><input type="text" id="prima2" class="txt_box2"   value="" readOnly></td>
                              </tr>
                              <tr>
                                <td class='cell100 column70 text-success'>SALDO: $</td>
                                <td class='cell100 column30'><input type="text" id="saldo2" class="txt_box2"   value="" readOnly></td>
                              </tr>
                              <tr>
                                <td class='cell100 column70 text-success'>NUMERO DE MESES </td>
                                <td class='cell100 column30'><input type="text" id="nmeses2" class="txt_box2"    value="" readOnly></td>
                              </tr>
                              <tr>
                                <td class='cell100 column70 text-success'>CUOTA MENSUAL </td>
                                <td class='cell100 column30'><input type="text" id="cuotames2" class="txt_box2"  value="" readOnly></td>
                              </tr>
                              <tr>
                                <td class='cell100 column70 text-success'>FECHA VENCE MES : </td>
                                <td class='cell100 column30'><input type="text" id="diavence2" class="txt_box2"  value="" readOnly></td>
                              </tr>
                              <tr>
                                <td class='cell100 column100 text-success'> <div class=' msjfecha'></div></td>
      ...
      <?php
              ...
              echo "<script src='js/plugins/cellNavigate.js'></script>";
                echo "<script src='js/plugins/datapicker/moment.min.js'></script>";
    ...
    <script src="js/funciones/main.js"></script>';
              echo "<script src='js/funciones/venta_cuotas.js?t".rand(0, 9999)."=".rand(0, 9999)."'></script>";
...
function insertar()
{
    ...
    //json cotizacion
    $jsonCotiza=$_POST['jsonCotiza'];
    $total = $retencion+$_POST['total'];
    $arrayJsonCotiza = json_decode($jsonCotiza, true);

    $total  = $arrayJsonCotiza['totalfinal'];
  ...
  ";
    ...
    $tipo_entrada_salida='';
   /*
       1- poner el valor total del credito   como total de la factura
      2 - poner el saldo pendiente al credito
      3- poner la prima como abono
      4- eso para imprimir en el documento
   */
    ...
    if ($id_factura=="") {
      ...
      'total_menos_retencion'=>$arrayJsonCotiza['totalfinal'],
      'total' => $arrayJsonCotiza['totalfinal'], //total del credito
      'subtotal' => $arrayJsonCotiza['totalfinal'],
      'sumas'=> $arrayJsonCotiza['totalfinal'],
      'suma_gravado'=>$arrayJsonCotiza['totalfinal'],
      'credito' =>1,
      'abono' => $arrayJsonCotiza['prima'],
      'saldo' => $arrayJsonCotiza['saldo'],
      ...
      'clave' => $clave,
      'extra_nombre' => "",
      'pagar' =>$arrayJsonCotiza['totalfinal'],
      'tipo_pago' =>$tipo_pago,
      'total_credito' =>$arrayJsonCotiza['totalfinal'],
  ...
  $vtacta=1;
  $table_vta=" venta_cuota";
  list($yy,$mm,$dd)=explode("-",$arrayJsonCotiza['fecha_credito']);
  $form_vta= array(
  'id_cliente'   => $id_cliente,
  'id_factura'   => $id_fact,
  'fecha_inicio' => $arrayJsonCotiza['fecha_credito'],
  'total'        => $arrayJsonCotiza['totalfinal'],
  'prima'        => $arrayJsonCotiza['prima'],
  'abono'        => $arrayJsonCotiza['prima'],
  'saldo'        => $arrayJsonCotiza['saldo'],
  'valorcuota'   => $arrayJsonCotiza['monto_cuota'],
  'numerocuotas' => $arrayJsonCotiza['numcuotas'],
  'diavence'       => $dd,
  'porcent_total'  => $arrayJsonCotiza['porc_total'],
  'comision_venta' => $arrayJsonCotiza['comision_venta'],
  'id_vendedor'    => $arrayJsonCotiza['id_vendedor'],

  );
  $insVtaCuota=_insert($table_vta, $form_vta);
  if ($insVtaCuota) {
    $table_cuota=" cuota";
    $id_venta_cuota= _insert_id();
    $form_cuota= array(
    'id_venta_cuota' => $id_venta_cuota,
    'fecha_vence'    => $arrayJsonCotiza['fecha_credito'],
    'valorcuota'     => $arrayJsonCotiza['prima'],
    'abonocuota'     => $arrayJsonCotiza['prima'],
    'cuotanumero'    => 0,
    'pagada'         =>1,
    'fecha_pago'     => $arrayJsonCotiza['fecha_credito'],
    'id_factura'     => $id_fact,
    );
    $insCuota0=_insert($table_cuota, $form_cuota);
    for ($k=1;$k<=$arrayJsonCotiza['numcuotas'];$k++){
      $fvence= addMonths($k, $arrayJsonCotiza['fecha_credito']);
      $form_cuota= array(
      'id_venta_cuota'=> $id_venta_cuota,
      'fecha_vence'   => $fvence,
      'valorcuota'    => $arrayJsonCotiza['monto_cuota'],
      'saldocuota'    => $arrayJsonCotiza['monto_cuota'],
      'cuotanumero'   => $k,
      'pagada'        => 0,
      );
      $insCuota=_insert($table_cuota, $form_cuota);
    }

  } else {
      $vtacta=0;
  }
  //movimiento producto por venta
    ...
    if ($cuantos>0) {
        ...
        $dats_caja = getCaja($caja);
        $nombrecaja =$dats_caja['nombre'];
        $resCte = cliente_factura($id_fact);
        $row_client =_fetch_assoc($resCte);
        if ($a&&$b&&$c&&$x&&$z&&$k&&$j&&$l&&$cre) {
            ...
            $xdatos['cliente']= $row_client['nombre'];
        } else {
...
function imprimir_fact()
{
    ...
    case 'TIK':
      $nreg_encode =print_ticket_cuotas($id_factura);
      break;
    case 'COF':
      $nit= $_POST['nit'];
      $nrc= $_POST['nrc'];
...
function mostrar_cliente()
{
    ...
    if ($count>0) {
        ...
        $sqlcat="SELECT nombre FROM categoria_proveedor
        WHERE id_categoria='".$row['categoria']."'";
        $rcat = _query($sqlcat);
...
function modalPago1(){
 ?>
  <div class="modal fade" id="modalPago" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <!-- poner el valor total del credito  -->
        <div class="modal-dialog">
            ...
            <div class="modal-body">
              <div class="row text-center">
                ...
                <div class="row">
                  ...
                  <table	class="table table-condensed" id="tableview">
                  <tbody id='efecttiv' >
                    <tr class='effectivo'>
              ...
              <div class="row"><br>
                <div class="col-md-4 text-center">
                  <button type="button" class="btn btn-info" id="btnAddPayment">
                <i class="fa-solid fa-file-invoice-dollar"></i>Ctrl+ A => Pago </button>
                </div>
                  <div class="col-md-4 text-center">
                  <button type="button" class="btn btn-success" id="btnPrintFact" disabled>
                    <i class="fa fa-print"></i> Ctrl+P => Imprimir</button>
                </div>
                <div class="col-md-4 text-center">
                  <button type="button"  class="btn btn-danger" id="btnEsc" disabled>
                    <i class="fa fa-stop"></i> &nbsp;&nbsp;Esc Salir &nbsp;&nbsp</button>
                </div>
              </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content  modal-custom">
            ...
            <div class="modal-body">
              <div class="row">
              <div class="col-md-6 text-center" >
                  <h5 class="text-primary text-center">&nbsp;Cliente :
                  <span class="  text-success"id='nombrecliente'></span></h5>
              </div>
              <div class="col-md-6 text-center" >
                  <h5 class="text-primary text-center">&nbsp;Documento :
                  <span class="  text-success"id='fact_num'></span></h5>
              ...
              <div class="row">
            <div class="col-md-2">
              <h5 class="text-primary text-center">Total: $</h5>
            </div>
            ...
            <div class="col-md-2">
              <h5 class="text-primary text-center">Prima: $</h5>
            </div>
            <div class="col-md-2"><strong>
              <input type="text" id="primavalor" name="primavalor" value=""
              class="input_clear text-green" readonly ></strong>
            </div>
            <div class="col-md-2">
              <h5 class="text-primary text-center">Saldo: $</h5>
            </div>
            <div class="col-md-2"><strong>
              <input type="text" id="saldovalor" name="saldovalor" value=""
              class="input_clear text-green" readonly ></strong>
            </div>
              ...
              <div class="row">
              <div class="col-md-12 tablaPagos"  >
                <div class="table-responsive">
                  <table class='table table-bordered' id='pagoss'>
                    <thead>
                      <th class="col-lg-3">PAGO</th>
...
//modal cotizacion
function modalCotiza(){
  $fecha=date('Y-m-d');
  ?>
  <div class="modal fade" id="modalCotiza" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-custom">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel">DATOS CREDITO POR CUOTAS</h4>
                        </div>
                        <div class="modal-body">
              ...
              <div class='col-md-6 col-sm-6 col-xs-6 form-group has-feedback'>
               <label class="control-label">Monto Cotizar Plazos: </label>
               <input type='text' id='valorcredito' name='valorcredito' class='form-control has-feedback-right' readonly >
              </div>
							  <div class='col-md-6 col-sm-6 col-xs-6 form-group has-feedback'>
								<label class="control-label">Fecha Credito: </label>
									<input name='fecha_credito' id='fecha_credito' type='date' value='<?php echo $fecha;?>' class='date-picker form-control col-md-8 col-xs-8' required='required'>
							  </div>
                <?php
                ...
                <select class='form-control ' id='plazocuotas' name='plazocuotas' required>
                <?php
                // Loops over each int  from current  , back to the $earliest
                foreach ( range( $earliest,$latest   ) as $i ) {
                  // Prints the option with the next year in range.
                  if($i>1)
                    $txtmonth=" MESES";
                  echo '<option value="'.$i.'"'.($i === $currently_selected ? ' selected="selected"' : '').'>'.$i.$txtmonth.'</option>';
                }
                ?>
              </select>
	           </div>
             <div class='col-md-6 col-sm-6 col-xs-6 form-group has-feedback'>
               <label class="control-label">% minimo </label>
                 ...
                 <input type='text' id='porc_minimo' name='porc_minimo' class='form-control decimal'   value='' placeholder='Efectivo' >
             </div>
						<div class='col-md-6 col-sm-6 col-xs-6 form-group has-feedback'>
							<label class="control-label">Prima: </label>
								<input type='hidden' id='cero' name='cero' class='form-control has-feedback-right' value='0' >
								<input type='text' id='efectivoprima' name='efectivoprima' class='form-control decimal'   value='' placeholder='Efectivo' >
						</div>
							<div class='col-md-6 col-sm-6 col-xs-6 form-group has-feedback'>
							<label class="control-label">Restan: </label>
								<input type='text' id='saldo' name='saldo' class='form-control has-feedback-right' placeholder='0.00' readonly>

							</div>

							<div class='col-md-6 col-sm-6 col-xs-6 form-group has-feedback'>
							<label class="control-label">Cuota: </label>
								<input type='text' id='cuota' name='cuota' class='form-control has-feedback-right' placeholder='0.00' readonly>
         ...
         <div class='row'>
                ...
                <?php
                  $array1=getVendor();
                  $select=create_select("id_vendedor2", $array1, '-1', "width:100%;");
                  echo $select; ?>
              </div>

						<div class='col-md-6'>
							<label class="control-label">% de Comisión: </label>
								<input type='number' id='comision' name='comision' class='form-control' step="0" min="0" max="50" value='' placeholder='Comisión' required onfocus='this.select();'>
              ...
              <center>
								...
								<button type='submit' id='btnCalCotiza' name='btnCalCotiza' class='btn btn-round btn-success addf'><i class='fa fa-money'></i> Finalizar</button>
							</center>
							<!--input type='hidden' name='detalle' value=''>
							<input type='hidden' name='finalizarprima' value='1'>
							<input type='hidden' id='hora' name='hora' value=' 22:14:56'>
							<input type='hidden' name='idinsertcomprobante' value='2011'>
							<input type='hidden' name='id_bodega' value='stock'-->
						</div>
            </div>
...
function getParamCuotas()
{
  $fecha=date('Y-m-d');
  $sql="SELECT porc_min_prima,porc_min_int_mes
  FROM parametros_cuota WHERE fecha_inicio<'$fecha'
  AND  activo=1";
    $result= _query($sql);
    $array = array();
