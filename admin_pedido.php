						  ...
						  <div class="input-group">
								 <div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" placeholder="Fecha Inicio" class="datepicker form-control" id="fecha_inicio" name="fecha_inicio" value="<?php echo  $fechaanterior;?>">
									</div>
                                </div>
                            ...
                            <div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" placeholder="Fecha Fin" class="datepicker form-control" id="fecha_fin" name="fecha_fin" value="<?php echo $fechahoy;?>">
									</div>
                                </div>
                                <div class="col-md-4">
