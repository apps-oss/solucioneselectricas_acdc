...
$title_report=" INVENTARIO DE ACEITES / LUBRICANTES";
...
$table->endTable();
$headers='{10,20,50,20,20,20,20,20,20,20}';
...
if ($count>0 ){
    ...
    for($i=1;$i<=$count;$i++){
          ...
          $row3=getAceiteLubByProd($id_producto,$id_sucursal,$fecha);
          $invinit=$row2[0]+$row3[1];
          ...
          $table->easyCell( $invinit,'align:R;');
          $table->easyCell( "",'align:R;');
          $table->easyCell( $row2[0],'align:R;');
          $table->easyCell( "",'align:R;');
          $table->easyCell( $row3[1],'align:R;');
          $table->easyCell( $row3[2],'align:R;');
          $table->easyCell( $row3[0],'align:R;');
          $total+=$row3[1];
          $total_qty+=$row3[0];
          $table->printRow();
          if(!($i%$lcut) && $i>0){
      ...
      $table->rowStyle('valign:M;border:LRB;paddingY:2;font-size:8' );
      $table->easyCell("TOTAL",'align:C;colspan:7;');
      $table->easyCell( "<b> ".sprintf("%.2f",$total)."</b>",'align:R;');
      $table->easyCell("",'align:C;');
      $table->easyCell( "<b>$ ".sprintf("%.2f",$total_qty)."</b>",'align:R;');
      $table->printRow();
}
...
function getHeaders($table){
  ...
  $table->easyCell('<b>INICIAL</b>','align:C;');
  $table->easyCell('<b>REPONE</b>','align:C;');
  $table->easyCell('<b>INV. FINAL</b>','align:C;');
  $table->easyCell('<b>CONSUMO</b>','align:C;');
  $table->easyCell('<b>VENTA</b>','align:C;');
  $table->easyCell('<b>PRECIO $</b>','align:C;');
