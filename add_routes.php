...
function initial()
{
  ...
  <div class="wrapper wrapper-content  animated fadeInRight">
              ...
              <section>
                <div class="row">
                  <div class="form-group col-md-5">
                    <!--div id="a"-->
                      <label id='buscar_habilitado'>Buscar Cliente</label>
                      <div id="scrollable-dropdown-menu">
                      <input type="text" id="cliente" name="cliente"   class=" form-control " placeholder="cliente " data-provide="typeahead" style="border-radius:0px;width:100% !important;">
                      </div>
                    <!--/div-->
    ...
    <?php
    include ("footerb.php");
    echo "<script src='js/funciones/add_routes.js'></script>";
  } //permiso del script
  else {
