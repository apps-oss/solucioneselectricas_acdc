...
<div class="gray-bg">
  <div class="wrapper wrapper-content  animated fadeInRight">
          ...
          if ($links!='NOT' || $admin=='1') {
            ...
            <div  class="form-group col-md-2">
              <div class="form-group has-info">
                ...
                <input maxlength="6" type="text" class="form-control" id="numdoc" name="numdoc" value="">
              </div>
            </div>
                          ...
                          <table>
                            <tbody>
                              ...
                              <!--tr>
                                ...
                                <!--td class='cell100 column30'--> <input type="hidden" id="efectivov" class="txt_box2"   value="0"> <!--/td>
                              </tr>
                              <tr>
                                <td class='cell100 column70 text-success'>CAMBIO: $</td-->
                                <!--td class='cell100 column30'--><input type="HIDDEN" id="cambiov" class="txt_box2"   value="0" readOnly><!--/td>
                              </tr-->
    ...
    include_once("footer.php");
    echo "<script src='js/funciones/venta2.js?t".rand(0,9999)."=".rand(0,9999)."'></script>";
...
function insertar()
{
  ...
  if ($credito==1) {
    ...
    $form_data = array(
      ...
      'id_factura' => $id_fact,
      'dias' =>  '30',
      'total' => $total_menos_retencion - $total_bonifica,
      'abono' => 0,
      'saldo' => $total_menos_retencion - $total_bonifica,
      'finalizada' => 0,
      'id_sucursal' => $id_sucursal,
