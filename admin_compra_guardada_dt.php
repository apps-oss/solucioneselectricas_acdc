<?php
  ...
  'host' => $hostname
	...
	$joinQuery = "
	FROM compra2 as compra left JOIN usuario ON usuario.id_usuario=compra.id_empleado
	";
	...
	array( 'db' => 'compra.total', 'dt' =>4, 'field' => 'total' ),
	array( 'db' => 'compra.alias_tipodoc', 'dt' =>5, 'field' => 'alias_tipodoc' ),
	array( 'db' => 'compra.numero_doc ', 'dt' =>6, 'field' => 'numero_doc' ),
		array( 'db' => 'compra.id_compra', 'dt' => 7, 'formatter' => function( $id_movimiento, $row ){
		$menudrop="<div class='btn-group'>
			...
			$admin=$_SESSION["admin"];
								...
								if ($link!='NOT' || $admin=='1' )
									$menudrop.="<li><a  href='$filename?id_compra=$id_movimiento'><i class=\"fa fa-edit\"></i> Editar y finalizar</a></li>";
							$menudrop.="</ul>
						</div>";
						return $menudrop;},
						'field' => 'id_compra' ),
